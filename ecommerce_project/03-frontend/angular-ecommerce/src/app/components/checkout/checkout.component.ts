...
export class CheckoutComponent implements OnInit {
  ...
  onSubmit() {
    ...
    const shippingAddressControl = this.checkoutFormGroup.controls['shippingAddress'];
    if (shippingAddressControl) {
        purchase.shippingAddress = shippingAddressControl.value;
    ...
    const billingAddressControl = this.checkoutFormGroup.controls['billingAddress'];
    if (billingAddressControl) {
        purchase.billingAddress = billingAddressControl.value;
  ...
  resetCart() {
    ...
    // navigate back to the product image
